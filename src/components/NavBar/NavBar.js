      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex items-center justify-between border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              <span className="font-sans text-lg">Brooke Kennison Frontend Developer</span>
            </a>
          </div>
          ...
          <a href="/technologies" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Technologies
            </a>
